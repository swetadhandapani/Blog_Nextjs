    ...
    return (
        ...
        <form onSubmit={handleSubmit} class="w-full max-w-lg">
            ...
            <div class="flex items-center mb-4">
                ...
                <textarea id="message" name="message" onChange={handleInput} value={inputs.message??""} class=" text-black border rounded px-2 py-1 w-3/4" rows="4"></textarea>
            </div>
